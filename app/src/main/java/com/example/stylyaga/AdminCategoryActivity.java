...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    private String CategoryName, Desctiption, Price, Name, saveCurrentDate, saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputProductImage = (ImageView) findViewById(R.id.choose_image);
    ...
    private void ValidateProductData() {
        ...
        Desctiption = InputProductDescription.getText().toString();
        ...
        } else if (TextUtils.isEmpty(Desctiption)){
    ...
    private void StoreProductInformation() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AdminCategoryActivity.this, "Image upload successfully.", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(AdminCategoryActivity.this, "Product image save to database successfully.", Toast.LENGTH_SHORT).show();
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("description", Desctiption);
